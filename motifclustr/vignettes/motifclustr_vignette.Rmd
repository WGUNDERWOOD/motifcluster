...
spectrum = run_motif_embedding(G3, motif_name = "M1", motif_type = "func",
  mam_weight_type = "unweighted", mam_method = "sparse", num_eigs = 2, type_lap = "rw")
spectrum$vals
spectrum$vects
```
...
`motifclustr` to recover the blocks of a DSBM,
...
A value of one indicates perfect recovery of the blocks.
