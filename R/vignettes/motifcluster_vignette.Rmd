---
title: "Using the `motifcluster` package"
...
vignette: >
  %\VignetteIndexEntry{Using the `motifcluster` package}
...
The functionality of the `motifcluster` package falls into a few main categories:
...
The package can be installed and loaded using the `devtools` package:
