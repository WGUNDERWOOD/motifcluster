# motifcluster 0.1.0 CRAN submission comments

## R CMD check results

### Local install

There were no ERRORs, WARNINGs or NOTEs on my local install:

- Arch Linux 5.6.4-arch-1, R-release (R 4.0.0)

### Travis CI

There were no ERRORs, WARNINGs or NOTEs on any of the Travis CI builds below:
