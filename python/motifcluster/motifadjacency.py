  ...
  if mam_method == "sparse":
    ...
    if mam_weight_type == "mean":
      if motif_type == "func":
        ...
        J = mcin._build_J(adj_mat)
        G = mcin._build_G(adj_mat)
        C = mcut._a_b_one(Jd, G) - Jd * G + mcut._a_b_one(Gd, J) - Gd * J
  ...
  if mam_method == "sparse":
    ...
    if mam_weight_type == "mean":
      if motif_type == "func":
        ...
        J = mcin._build_J(adj_mat)
        G = mcin._build_G(adj_mat)
        C = mcut._a_one_b(Jd, G) - Jd * G + mcut._a_one_b(Gd, J) - Gd * J
  ...
  if mam_method == "sparse":
    ...
    if mam_weight_type == "mean":
      if motif_type == "func":
        ...
        Gd = mcin._build_Gd(adj_mat)
        Id = mcin._build_Id(adj_mat)
        C = mcut._a_b_one(Jd, Gd) - Jd * Gd + mcut._a_b_one(Gd, Jd) - Gd * Jd
